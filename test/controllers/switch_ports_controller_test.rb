...
class SwitchPortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create switch_port" do
    assert_difference('SwitchPort.count') do
      post switch_ports_url, params: { switch_port: { client_record_id: @switch_port.client_record_id, network_switch_id: @switch_port.network_switch_id, notes: @switch_port.notes, port_number: @switch_port.port_number, server_record_id: @switch_port.server_record_id, user_id: @switch_port.user_id } }
    end
  ...
  test "should update switch_port" do
    patch switch_port_url(@switch_port), params: { switch_port: { client_record_id: @switch_port.client_record_id, network_switch_id: @switch_port.network_switch_id, notes: @switch_port.notes, port_number: @switch_port.port_number, server_record_id: @switch_port.server_record_id, user_id: @switch_port.user_id } }
